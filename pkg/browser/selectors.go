...
const (
	// LoginEmailSelector defines the name value for the element in which to type login emails.
	LoginEmailSelector = "identifier"
	...
	// LoginPasswordSelector defines the name value for finding the field in which to type the login passwords.
